...
function AddServiceCard() {
  ...
  return (
    <div className="bg-white rounded-xl shadow-xl p-18 border-l-4 w-2/3">
      <div className="flex items-center justify-between mb-6">
        ...
        <button
          ...
          disabled={loading}
          className="bg-teal-600 hover:bg-teal-700 text-white font-semibold py-2 px-5 rounded shadow disabled:opacity-50"
        >
